...
const sections = {
  education: {
    ...
    content: [
      ...
      '  STI College of Technology General Santos',
      '  Period: 2021 - 2025',
      '',
      '> Relevant Coursework:',
  ...
  experience: {
    ...
    content: [
      ...
      '  - Verifying AI Generated Data and providing feedback for improvement',
      '',
      '> Intern @ LGU',
      '  February 2025 - June 2025',
      '  - Networking and IT support for local government systems',
